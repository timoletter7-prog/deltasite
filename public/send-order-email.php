...
$headers = "From: info@mydigibalance.nl\r\n";
$headers .= "Reply-To: info@mydigibalance.nl\r\n";
...
$logContext = stream_context_create([
    'http' => [
        'method' => 'POST',
        'header' => 'Content-Type: application/json',
...
try {
    file_get_contents('http://' . $_SERVER['HTTP_HOST'] . '/email-log.php', false, $logContext);
} catch (Exception $e) {
